  ...
  return (
    <>
      <Layout>
        ...
        <img
          className="fullwidth"
          src="/images/build/streams/2020-07-06.png"
          alt="Live Coding: Adding Payments with Stripe"
        />
        <section>
          <p>
          ...
          <p>
            ...
            <a href="https://twitter.com/thorwebdev">Thor Schaeff</a> from{" "}
            <a href="https://twitter.com/stripe">Stripe</a> in order to add
            subscription payments to Hoist.
          </p>
          <p>Join us to learn how to:</p>
          <ul>
            <li>
              add Stripe Checkout and the new customer portal to your Gatsby
              app;
            </li>
            <li>link your Auth0 users with Stripe customers;</li>
            <li>
              pull current subscription information from the Stripe API; and
            </li>
