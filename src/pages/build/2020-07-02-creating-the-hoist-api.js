  ...
  return (
    <>
      <Layout>
        ...
        <img
          className="fullwidth"
          src="/images/build/streams/2020-07-02.png"
          alt="Live Coding: Creating the Hoist API"
        />
        <section>
          <p>
          ...
          <p>
            In this session, I'll be creating a new Express API from scratch,
            and creating new content types in Sanity in preparation for the
            joint stream on Monday with Thor Schaeff from Stripe.
          </p>
          <p>By the end of the stream, we should have:</p>
          <ul>
            <li>Set up a new Express API;</li>
            <li>Deployed the API to Vercel;</li>
            <li>
              Created an endpoint to update users in Auth0 via Management API:
              <ul>
                <li>we'll be storing the Stripe Customer ID in there later;</li>
              </ul>
            </li>
